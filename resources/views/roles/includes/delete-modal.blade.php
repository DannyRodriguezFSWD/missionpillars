    ...
    <div class="modal-dialog modal-warning" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p data-msg="@lang('Are you sure you want to delete role :name:?')"></p>
                <small>@lang("This action can't be undone")</small>
            </div>
            <div class="modal-footer">
                <button id="button-delete" type="button" class="btn btn-warning" data-dismiss="modal">@lang('Delete Role')</button>
