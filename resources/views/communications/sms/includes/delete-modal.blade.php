    ...
    <div class="modal-dialog modal-warning" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>@lang('Are you sure you want to delete list:') <strong>{{ array_get($sms, 'subject') }}</strong>?</p>
...
{{ Form::open(['route' => ['sms.destroy', array_get($sms, 'id')], 'id' => 'form', 'method' => 'DELETE']) }}
{{ Form::hidden('uid', Crypt::encrypt(array_get($sms, 'id')) ) }}
{{ Form::close() }}
