<div class="modal fade" id="search-contact-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-primary" role="document">
        <div class="modal-content">
            {{ Form::open(['route' => ['recurring.search', 'contact'], 'method' => 'get']) }}
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    {{ Form::select('status', ['all' => __('All'), 'complete' => __('Complete'), 'pending' => __('Pending'), 'failed' => __('Failed'), 'refunded' => __('Refunded'), 'stub' => __('Stub')], null, ['class' => 'form-control']) }}
                </div>
            </div>
