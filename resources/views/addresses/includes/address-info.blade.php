<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group {{$errors->has('mailing_address_1') ? 'has-danger':''}}">
            ...
            {{ Form::text('mailing_address_1', null , ['class' => 'form-control', 'placeholder' => __('Mailing Adddress 1'), 'autocomplete' => 'off']) }}
        </div>
    </div>
</div>
<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group {{$errors->has('mailing_address_2') ? 'has-danger':''}}">
            ...
            {{ Form::text('mailing_address_2', null , ['class' => 'form-control', 'placeholder' => __('Mailing Adddress 2'), 'autocomplete' => 'off']) }}
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            {{ Form::text('p_o_box', null, ['class' => 'form-control', 'placeholder' => __('PO Box'), 'autocomplete' => 'off']) }}
        </div>
    </div>
    <div class="col-md-6">
        @if ($errors->has('city'))
...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            {{ Form::text('postal_code', null, ['class' => 'form-control', 'placeholder' => __('Postal Code'), 'autocomplete' => 'off']) }}
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
