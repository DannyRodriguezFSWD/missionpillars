    ...
    <div class="card-body">
        ...
        <div class="row mt-5">
            <div class="col-md-12 text-center">
                ...
                <h5>Income Statement by Fund {{ reportPeriod }}</h5>
            </div>
        </div>
            ...
            <table class="table borderless">
                <thead class="thead-inverse">
                    <tr>
                        ...
                        <th>Account Name</th>
                        <th v-for="(fund, index) in report.current_funds" :key="index">
                            {{ fund.name }}
                        </th>
                        <th>YTD Amount</th>
                        <th>&nbsp;</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td v-for="(fund, index) in report.current_funds" :key="index">&nbsp;</td>
                        <td>&nbsp;</td>
                        <th>&nbsp;</th>
                        <td>&nbsp;</td>
                    </tr>
                    <template v-for="income in report.income">
                        <tr v-for="account in income.accounts" :key="account.account_id">
                            ...
                            <td class="text-right" v-for="(fund, index) in account.funds" :key="index">
                                <span v-if="fund.amount < 0">
                                    (${{ fund.amount == null ? '0.00' : fund.amount.toFixed(2) }})
                                </span>
                                <span v-else>
                                    ${{ fund.amount == null ? '0.00' : fund.amount.toFixed(2) }}
                                </span>
                            ...
                            <td class="text-right">
                                <span v-if="account.total_funds < 0">
                                    (${{ account.total_funds == null ? '0.00' : account.total_funds.toFixed(2) }})
                                </span>
                                <span v-else>
                                    ${{ account.total_funds == null ? '0.00' : account.total_funds.toFixed(2) }}
                                </span>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td class="totals-number" v-for="(fund, index) in report.current_funds" :key="index">
                                &nbsp;
                            </td>
...
export default {
    ...
    methods: {
        ...
        getData(params){
            ...
            this.get({
                url: '/accounting/reports/income-statement-by-fund',
                data: params
            }).then(result => {
                ...
                this.report.current_funds = result.data.current_funds
