        ...
        'imageAttributes': function (context) {
            ...
            this.initialize = function () {
                ...
                var body = '<ul class="nav nav-tabs">' +
                        '  <li class="nav-item"><a class="nav-link active" href="#note-imageAttributes" data-toggle="tab">' + lang.imageAttributes.tabImage + '</a></li>' +
                        '  <li class="nav-item"><a class="nav-link" href="#note-imageAttributes-attributes" data-toggle="tab">' + lang.imageAttributes.tabAttributes + '</a></li>' +
                        '  <li class="nav-item"><a class="nav-link" href="#note-imageAttributes-link" data-toggle="tab">' + lang.imageAttributes.tabLink + '</a></li>';
